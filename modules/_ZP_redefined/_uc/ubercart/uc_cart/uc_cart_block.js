...
$(document).ready(function() {
  ...
  $('.cart-block-toggle').click(function() { cart_block_toggle(this); } );
});
...
function cart_block_toggle(parent) {
  
	//alert($(parent).parent().find('#block-cart-contents'));
	
	$(parent).parent().find('#block-cart-contents').toggle();
