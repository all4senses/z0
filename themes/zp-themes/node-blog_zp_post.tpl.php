<div class="test">blog zp POST via tpl </div>
...
<div class="blog post page">
	...
	//print '<div class="links">' . l(t('Return to blog'), 'node/233', array('class' => 'blog_link')) . '</div>';
	print '<div class="links">' . l(t('Return to blog'), MY_ZP_BLOG_NODE, array('class' => 'blog_link')) . '</div>';
