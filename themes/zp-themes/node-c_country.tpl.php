...
{ 
 ...
 echo '<div class="place_body">
   ...
   echo '<div class="images">';
	   ...
	   $photopath = base_path() . 'files/countries/' . $node->field_zp_art_place[0]['value'] . '/' . $node->field_zp_art_place[0]['value'];
    ...
    echo '<div class="list_title">Выберите город:</div>';
