...
{ 
 ...
 echo '<div class="place_body rajon">
   <div class="txt">';
  ...
  echo '<div class="images">';
	   ...
	   $photopath = base_path() . 'files/cities/' . substr($node->field_zp_art_place[0]['value'], 0, 4) . '/' . $node->field_zp_art_place[0]['value'];
    ...
    echo '<div class="list_title">Выберите магазин/салон:</div>';
